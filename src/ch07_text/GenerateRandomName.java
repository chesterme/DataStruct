...
public class GenerateRandomName {
    ...
    private String lastName = "赵    钱    孙    李    周    吴    郑    王    冯    陈    褚    卫    蒋    沈    韩    杨    朱    秦    尤    许    \n" +
            "\n" +
    ...
    private String firstName = "嘉懿 煜城 懿轩 烨伟 苑博 伟泽 熠彤\n" +
            "\n" +
    ...
    public GenerateRandomName(){
        lastNames = lastName.trim().split("\\s+");
        firstNames = firstName.trim().split("\\s+");
    ...
    public static void main(String[] args){
        GenerateRandomName generate = new GenerateRandomName();
        for(int i = 0; i < 100; i++){
